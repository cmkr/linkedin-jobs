...
search_terms = ["Software Engineer", "Software Developer", "Java Developer", "Node Developer", "React Developer", "Front End Developer", "Full Stack Developer", "Web Developer", "Python Developer"]
...
job_type = ["Full-time", "Part-time", "Contract", "Temporary", "Volunteer", "Internship"]                      # (multiple select) "Full-time", "Part-time", "Contract", "Temporary", "Volunteer", "Internship", "Other"
...
bad_words = ["US Citizen","USA Citizen","No C2C", "No Corp2Corp", ".NET", "Embedded Programming", "Ruby", "CNC"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
